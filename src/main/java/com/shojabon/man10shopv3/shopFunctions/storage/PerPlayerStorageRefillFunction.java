...
@ShopFunctionDefinition(
        internalFunctionName = "perPlayerStorageRefill",
        name = "プレイヤー別分間ごとの補充設定",
        explanation = {"プレイヤー別で取引を制限します", "分間毎の取引を設定した個数までとします", "どちらかが0の場合設定は無効化"},
        enabledShopType = {},
        iconMaterial = Material.FURNACE_MINECART,
        category = "倉庫設定",
        allowedPermission = "MODERATOR",
        isAdminSetting = false
)
public class PerPlayerStorageRefillFunction extends ShopFunction {

    //init
    public PerPlayerStorageRefillFunction(Man10Shop shop, Man10ShopV3 plugin) {
        super(shop, plugin);
    }
